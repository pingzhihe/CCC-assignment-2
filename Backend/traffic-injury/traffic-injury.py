...
def main():
    ...
    search_data = {
        "size": 100,
        "_source": ["_id", "phn_name", "dth_rd_t80", "dth_rd_t83","geometry"],
        "query": {"match_all": {}}
    }
    ...
    try:
        ...
        for doc in hits:
            _id = doc['_id']
            source = doc['_source']
            ratio_traffic_injury = source.get('dth_rd_t80')
            count_traffic_injury = source.get('dth_rd_t83')
            ...
            if geometry_data:
                ...
                if geometry:
                    features.append({
                        '_id': _id,
                        'count_traffic_injury': count_traffic_injury,
                        'ratio_traffic_injury': ratio_traffic_injury,
                        'phn_name': phn_name,
                        'geometry': geometry
                    })
